...
$medium     = get_field('medium_link', options);
...
$vine       = get_field('vine_link', options);
                    ...
                    <div class="site-info col-sm-4 col-sm-offset-1">
                        ...
                        <div class="social-links text-center">
                            <ul class="list-inline">
                                ...
                                <?php if ( $googleplus ) : ?>
                                    <li>
                                        <a href="//plus.google.com/+<?php echo $googleplus; ?>" target="_blank">
                                ...
                                <?php if ( $linkedin ) : ?>
                                    <li>
                                        <a href="//www.linkedin.com/pub/<?php echo $linkedin; ?>" target="_blank">
                                ...
                                <?php if ( $pinterest ) : ?>
                                    <li>
                                        <a href="//www.pinterest.com/<?php echo $pinterest; ?>" target="_blank">
                                ...
                                <?php if ( $tumblr ) : ?>
                                    <li>
                                        <a href="//<?php echo $tumblr; ?>.tumblr.com" target="_blank">
                                ...
                                <?php if ( $medium ) : ?>
                                    <li>
                                        <a href="//medium.com/@<?php echo $medium; ?>" target="_blank">
                                ...
                                <?php if ( $flickr ) : ?>
                                    <li>
                                        <a href="//www.flickr.com/people/<?php echo $flickr; ?>" target="_blank">
                                ...
                                <?php if ( $vine ) : ?>
                                    <li>
                                        <a href="//vine.co/<?php echo $vine; ?>" target="_blank">
                                            <i class="fa fa-vine fa-2x"></i>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if ( $youtube ) : ?>
                                    <li>
                                        <a href="//www.youtube.com/user/<?php echo $youtube; ?>" target="_blank">
